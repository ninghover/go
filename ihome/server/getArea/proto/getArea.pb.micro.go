...
type GetAreaService interface {
	GetArea(ctx context.Context, in *AreaReq, opts ...client.CallOption) (*AreaRsp, error)
}
...
func (c *getAreaService) GetArea(ctx context.Context, in *AreaReq, opts ...client.CallOption) (*AreaRsp, error) {
...
func (h *getAreaHandler) GetArea(ctx context.Context, in *AreaReq, out *AreaRsp) error {
