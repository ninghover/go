...
// Facility /* 设施信息 table_name = "facilities"*/
...
// HouseImage /* 房屋图片 table_name = "house_images"*/
...
// OrderHouse /* 订单 table_name = order_hourses */
